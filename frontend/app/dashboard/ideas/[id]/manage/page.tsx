...
import { ArrowLeft, Trash2, Settings, BarChart3, Loader2, AlertTriangle, Star, Eye, Target, Lightbulb, Users, Share2, ThumbsUp } from 'lucide-react'
                ...
                <div className="space-y-8 max-w-lg">
                  <div className="card-zed p-8">
                    ...
                    <button
                      ...
                      className="btn-primary px-6 py-3 rounded-xl text-xs font-black"
                    >
                  ...
                  <div className="card-zed p-8 border-red-500/20">
                    ...
                    <button
                      ...
                      disabled={deleting}
                      className="px-6 py-3 rounded-xl text-xs font-black bg-red-500/20 text-red-400 border border-red-500/30 hover:bg-red-500/30 transition-all"
                    >
