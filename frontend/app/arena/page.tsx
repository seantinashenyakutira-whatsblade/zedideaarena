    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-b from-[#0f0f1a] via-[#1a1a2e] to-[#0f0f1a]">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#0f0f1a]/80 via-[#1a1a2e]/60 to-[#0f0f1a]/90" />
          
          <div className="relative max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1e1e3f]/80 border border-[#2e2e5a] mb-6">
              <Flame className="w-4 h-4 text-[#f59e0b]" />
              <span className="text-[#c7d2fe] text-sm font-medium">Live Competitions</span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#f8fafc] mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <button className="px-8 py-3.5 border border-[#2e2e5a] text-[#f8fafc] font-semibold rounded-lg hover:bg-[#1e1e3f] hover:border-[#3e3e7a] transition-all duration-300">
                View Leaderboard
              </button>
            </div>
          </div>
            ...
            {[
              ...
              <div key={index} className="glass-card rounded-xl p-6 card-hover">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg bg-[#1e1e3f] flex items-center justify-center">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
              <div>
                ...
                <p className="text-[#94a3b8]">Join these exciting challenges and win prizes</p>
              </div>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${
                      activeFilter === filter
                        ...
                        : "bg-[#1e1e3f] text-[#94a3b8] hover:text-[#f8fafc] hover:bg-[#2e2e5a]"
                    }`}
                  >
            ...
            <div className="mb-8">
              <input
                ...
                className="w-full max-w-md px-4 py-3 rounded-lg bg-[#1e1e3f] border border-[#2e2e5a] text-[#f8fafc] placeholder-[#64748b] focus:border-[#6366f1] focus:outline-none focus:ring-2 focus:ring-[#6366f1]/20 transition-all duration-300"
              />
            </div>
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="px-2 py-1 bg-[#1e1e3f] rounded text-xs font-medium text-[#c7d2fe]">
                    ...
                    <h3 className="text-xl font-bold text-[#f8fafc] mb-2 group-hover:text-[#c7d2fe] transition-colors duration-300">
                      {competition.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-[#f8fafc] font-bold">{competition.prize}</span>
                      </div>
        ...
        <section className="py-12 px-4 sm:px零售-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-2 mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[#f8fafc]">Trending Now</h2>
            </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-bold text-[#f8fafc] mb-1 truncate">
                        {competition.title}
                      </h3>
                      <p className="text-[#94a3b8] text-sm mb-2">{competition.category}</p>
