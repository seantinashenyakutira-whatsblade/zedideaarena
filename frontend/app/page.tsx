        ...
        <section className="relative pt-20 pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--bg-card)]/80 border border-[var(--border)] mb-8">
                <Sparkles className="w-4 h-4 text-[#22d3ee]" />
                <span className="text-[var(--text-accent)] text-sm font-medium">Join the Future of Competition</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <button className="w-full sm:w-auto px-8 py-4 border border-[var(--border)] text-[var(--text-primary)] font-semibold rounded-xl hover:bg-[var(--surface-hover)] hover:border-[var(--border-hover)] transition-all duration-300 flex items-center justify-center gap-2">
              ...
              <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center">
                    <p className="text-3xl sm:text-4xl font-bold text-[var(--text-primary)] mb-1">{stat.value}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="glass-card rounded-2xl p-6 card-hover">
                  ...
                  <p className="text-[var(--text-primary)] mb-6">"{testimonial.content}"</p>
            ...
            <div className="glass-card rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <button className="w-full sm:w-auto px-8 py-4 border border-[var(--border)] text-[var(--text-primary)] font-semibold rounded-xl hover:bg-[var(--surface-hover)] transition-all duration-300">
                    Learn More
                  </button>
                </div>
              </div>
