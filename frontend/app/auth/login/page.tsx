  ...
  return (
    <div className="min-h-screen bg-zed-background flex items-center justify-center px-4">
      <div className="w-full max-w-md animate-zed-fade-up">
        ...
        <div className="card-zed mb-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <label htmlFor="rememberMe" className="text-sm text-zed-foreground-secondary">Remember me</label>
            </div>
            ...
            <button type="submit" disabled={loading} className="btn-primary w-full flex items-center justify-center gap-2 mt-6 disabled:opacity-50">
        ...
        <div className="mb-6">
          <button type="button" onClick={handleGoogleSignIn} disabled={loading} className="btn-secondary w-full flex items-center justify-center gap-2">
        ...
        <p className="text-center text-zed-foreground-secondary">
          ...
          <Link href="/auth/signup" className="text-zed-primary hover:underline font-medium">Sign Up</Link>
        </p>
      </div>
    </div>
  )
