...
import { toast } from 'sonner' // Assuming sonner is used for toasts, or maybe just standard error handling. Wait, we don't know if sonner is available. Let's just use console/alert or error state.
      ...
      <div className="w-full max-w-md animate-zed-fade-up">
        ...
        <div className="card-zed mb-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Error Message */}
            {error && (
              <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20 text-red-500 text-sm font-bold animate-pulse">
                {error}
              </div>
            )}
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="btn-primary w-full flex items-center justify-center gap-2 mt-6 click-push glow-primary"
            >
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 relative z-10">
          <button 
            ...
            disabled={loading}
            className="btn-secondary flex items-center justify-center gap-3 click-push glass-premium hover:bg-white/5 border border-white/5 py-3"
          >
            <Github size={18} />
          ...
          <button 
            ...
            className="btn-secondary flex items-center justify-center gap-3 click-push glass-premium hover:bg-white/5 border border-white/5 py-3"
          >
            {/* Custom Google SVG Icon since standard Lucide doesn't have it explicitly */}
        ...
        <p className="text-center text-zed-foreground-secondary">
          ...
          <Link href="/auth/login" className="text-zed-primary hover:underline font-medium">
            Sign In
          </Link>
        </p>
      </div>
