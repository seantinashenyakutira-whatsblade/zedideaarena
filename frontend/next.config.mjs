        ...
        headers: [
          ...
          { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co https://*.supabase.co https://onesignal.com https://zedideaarena.onrender.com https://hub.zedideaarena.com https://*.googlesyndication.com https://*.google-analytics.com https://va.vercel-scripts.com",
