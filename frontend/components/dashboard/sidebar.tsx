  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden btn-icon fixed top-4 left-4 z-50"
      >
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen w-64 glass-premium border-r border-white/5 transition-all duration-300 z-40 md:relative md:translate-x-0 ${
          isOpen ? 'translate-x-0 overflow-auto' : '-translate-x-full md:translate-x-0'
        }`}
      >
        {/* Logo */}
