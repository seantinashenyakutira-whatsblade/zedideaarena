...
import { Home, Trophy, Lightbulb, User, Vote, CheckCircle, Wallet, Settings, LogOut, Menu, X, AlertTriangle, Lock, Shield, Users, FileText, BarChart3, MessageCircle, Flag, LifeBuoy, DollarSign, ClipboardList } from 'lucide-react'
...
const adminNav = [
  ...
  { href: '/dashboard/admin/audit-log', icon: ClipboardList, label: 'Audit Log' },
  { href: '/dashboard/admin/messages', icon: MessageCircle, label: 'Messages' },
